...
- **Usage in ontologies**: Used to model event semantics, temporal reasoning, and narrative structures

## Context
In the engineering of ontologies domain, aspect provides a structural mechanism for representing the temporal morphology of events and their relationships within knowledge graphs.