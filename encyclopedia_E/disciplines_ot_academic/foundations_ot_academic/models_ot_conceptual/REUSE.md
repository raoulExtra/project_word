# Reusable Terms for Conceptual Models

This document identifies terms that can be reused from higher-level glossaries for use in various modeling and conceptual analysis domains.
...
**Key aspects**: Abstraction, Representation, Purposefulness
...
**Key aspects**: Generalization, Simplification, Focus
...
**Key aspects**: Necessity, Testability, Impact
...
**Key aspects**: Necessity, Boundary definition, Impact on outcomes
...
**Key aspects**: Symbolic, Structural, Behavioral
**Types**: Visual, Mathematical, Linguistic, Computational representations
...
**Key aspects**: Structural, Behavioral, Functional fidelity
...
**Key aspects**: Construct, Internal, External, Face validity
...
**Key aspects**: Domain limits, Condition requirements, Scale constraints
**Types**: Universal, Domain-specific, Context-dependent applicability
...
**Key aspects**: Spatial, Temporal, Conceptual, Scope boundaries
...
**Key aspects**: Simplification, Perfection, Abstraction
...
**Key aspects**: Parameter adjustment, Validation, Uncertainty quantification
**Types**: One-point, Multi-point, Dynamic calibration
...
**Key aspects**: Instrumentation, Calibration, Uncertainty
...
**Key aspects**: Time progression, State changes, Output generation
